...
Promise.all([
   ...
   import('/js/import_export_DATA.js')
  .then(module => { 
    console.log('[Content] import_export_DATA.js loaded');
        initializeBlockingLogic(); // Вызываем инициализацию после загрузки модуля
  })
  .catch(error => {
    console.error('[Content] Failed to load import_export_DATA.js module:', error);
   }),   
  
   import('/js/panel__Settings.js')
       .then(module => {
   ...
   import('/js/emojiSpamProtection.js').then(() => {
   ...
   import('/js/enable__disableBlocking.js').then(module => {
   ...
   import('/js/notifications.js').then(module => {
   ...
   import('/js/Logging___7BTVFZ__PANEL.js').then(module => {
   ...
   import('/js/7BTVFZ__storage.js')
       .then(module => {
        storage = module.default;
        console.log('[Content] 7BTVFZ__storage loaded');
   }),
     import('/rename-users-nickname/renamedTwitchUsers.js')
       .then(module => {
        storage = module.default;
        console.log('[Content] renamedTwitchUsers loaded');
   }) 
        .catch(error => {
        console.error('[Content] Failed to load renamedTwitchUsers:', error);
        showIsolatedNotification('Failed to load renamedTwitchUsers module', 5000);
   }), 
   import('/js/bindButtonHandlers.js').then(module => {
