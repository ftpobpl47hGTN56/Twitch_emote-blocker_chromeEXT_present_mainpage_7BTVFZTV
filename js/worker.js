...
function restoreEmotesAndViewerCard(emotePickerElements, viewerCardSelector) {
    let restoredCount = 0;
    let viewerCardRestored = false;
    ...
    console.log(`[Restore] Prevented hiding ${restoredCount} emotes, viewer card restored: ${viewerCardRestored}`);
}
 */