(function () {
    ...
    function initializeStorage() {
        ...
        if (!getStorage('emotePickerSelector')) {
            setStorage('emotePickerSelector', '[data-a-target="emote-picker-button"]');
            console.log('[Content] Initialized emotePickerSelector storage');
        }
...
//# sourceMappingURL=7BTVFZ__storage.js.map